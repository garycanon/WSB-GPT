...
from PyQt5.QtWidgets import (
    ...
    QTableWidgetItem, QMessageBox, QSpinBox, QInputDialog, QAbstractItemView, QHeaderView
)
...
class MarketDataTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.stock_table.verticalHeader().setVisible(False) # Added line to hide vertical header
        ...
        # Hide the vertical header (row numbers)
        self.watchlist_table.verticalHeader().setVisible(False) # Added line to hide vertical header
